...
<div class="row">
    <div class="col-lg-12">
                        ...
                        <div class="ibox-content">
                            <div>
                                <div class="feed-activity-list">
                                    ...
                                    <div class="feed-element">
                                        <a href="profile.html" class="pull-left">
                                            <?= $this->HTML->image('/Manage/img/layout/a2.jpg',array('class'=>'img-circle')) ?>
                                        </a>
                                        <div class="media-body ">
                                    ...
                                    <div class="feed-element">
                                        <a href="profile.html" class="pull-left">
                                            <?= $this->HTML->image('/Manage/img/layout/a3.jpg',array('class'=>'img-circle')) ?>
                                        </a>
                                        <div class="media-body ">
                                            <small class="pull-right">2h ago</small>
                                    ...
                                    <div class="feed-element">
                                        <a href="profile.html" class="pull-left">
                                            <?= $this->HTML->image('/Manage/img/layout/a5.jpg',array('class'=>'img-circle')) ?>
                                        </a>
                                        <div class="media-body ">
                                            <small class="pull-right">2h ago</small>
        ...
        <div class="footer">
            ...
            <div>
                <strong>Copyright</strong>&nbsp; Rikkeisoft.co.ltd  &copy;  2015-2016
            </div>
        </div>
    </div>
</div>
